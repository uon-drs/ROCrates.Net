...
public class Preview : File
{
    ...
    public Preview(ROCrate? crate = null, string? identifier = null, JsonObject? properties = null,
        string? source = null,
    ...
    public override void Write(string basePath)
    {
        ...
        var result = template.Render(new { data, root_dataset = RoCrate?.RootDataset });
