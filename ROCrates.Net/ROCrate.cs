...
public class ROCrate
{
    ...
    /// <summary>
    /// Initialise a new empty <see cref="ROCrate"/> object.
    /// </summary>
    public ROCrate()
    {
    ...
    /// <summary>
    /// Add entities to an <see cref="ROCrate"/>.
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// <summary>
    /// Add a person to the <see cref="ROCrate"/> and return the created <see cref="Person"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <remarks>A new <see cref="Person"/> with the given parameters.</remarks>
    ...
    /// <summary>
    /// Add a file to the <see cref="ROCrate"/> and return the created <see cref="File"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <returns>A new <see cref="File"/> with the given parameters.</returns>
    ...
    /// <summary>
    /// Add a dataset to the <see cref="ROCrate"/> and return the created <see cref="Dataset"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <param name="validateUrl">Check the URL?</param>
    /// <returns>A new <see cref="Dataset"/> with the given parameters.</returns>
    ...
    /// <summary>
    /// Add a workflow to the <see cref="ROCrate"/> and return the created <see cref="ComputationalWorkflow"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <param name="validateUrl">Check the URL?</param>
    /// <returns>A new <see cref="ComputationalWorkflow"/> with the given parameters.</returns>
    ...
    {
        var workflow =
            new ComputationalWorkflow(this, identifier, properties, source, destPath, fetchRemote, validateUrl);
    ...
    /// <summary>
    /// Add a test definition to the <see cref="ROCrate"/> and return the created <see cref="TestDefinition"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <param name="validateUrl">Check the URL?</param>
    /// <returns>A new <see cref="TestDefinition"/> with the given parameters.</returns>
    public TestDefinition AddTestDefinition(string? identifier = null, JsonObject? properties = null,
        string? source = null, string? destPath = null, bool fetchRemote = false, bool validateUrl = false)
    {
        var testDefinition =
            new TestDefinition(this, identifier, properties, source, destPath, fetchRemote, validateUrl);
        Add(testDefinition);
        return testDefinition;
    }

    /// <summary>
    /// Add a test suite to the <see cref="ROCrate"/> and return the created <see cref="TestSuite"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <returns>The <see cref="TestSuite"/> object with the given parameters.</returns>
    ...
    /// <summary>
    /// Add a test instance to the <see cref="ROCrate"/> and return the <see cref="TestInstance"/> object.
    /// </summary>
    /// <example>
    /// <code>
    /// var roCrate = new ROCrate();
    ...
    /// <summary>
    /// Save the <see cref="ROCrate"/> to disk. 
    /// </summary>
    /// <param name="location">
    ...
    /// <summary>
    /// <para>Initialise an <see cref="ROCrate"/> object from the contents of a directory that is a valid RO-Crate.</para>
    /// <para>
    ...
    /// </summary>
    /// <param name="source">
    /// The path to the directory containing the RO-Crate to initialise an <see cref="ROCrate"/> from.
    /// </param>
    ...
    /// and populates an <see cref="ROCrate"/> object with entities representing the contents of the RO-Crate.
